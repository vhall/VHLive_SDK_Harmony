...
|   版本号   |     日期     |                更新说明                |
|:-------:|:----------:|:----------------------------------:| 
| v1.5.8  | 2026-08-1  | 1:支持持聊天设置为精选事件；2：增加画中画退到后台是否自动开启控制 |  
| v1.4.0  | 2026-07-14 |              1:优化已知问题              |  
| v1.2.0  | 2026-03-24 |              1:优化已知问题              |  
| v1.1.0  | 2026-03-09 |             1:新增互动连麦能力             |  
| v1.0.16 | 2026-01-26 |            1:优化直播文档开启状态            |  
| v1.0.14 | 2025-12-23 |             1:优化初始化接口              |  
| v1.0.13 | 2025-12-8  |               1:接口优化               |  
| v1.0.12 | 2025-12-2  |           1:微吼直播鸿蒙版本SDK            |  
